package com.example.kgaj.chesstimer;
...
public class MainActivity extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        // onClicklistener daje nam akcje dla nacisniecia przycisku badz jakiegokolwiek widoku
        playerOneConstraint.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
                    if (playerTwoLeftTime > 0 && playerOneLeftTime > 0) // if to wiadomo
                    {
                        ...
                        playerTwoCountDownTimer = new CountDownTimer(playerTwoLeftTime, countDownInterval)
                        {
                            ...
                            public void onTick(long millisUntilFinished)
                            {
                                ...
                                playerTwoLeftTime = millisUntilFinished; // to zmiennej przypisujemy czas jaki został do konca gry
                            }
        ...
        // onClicklistener daje nam akcje dla nacisniecia przycisku badz jakiegokolwiek widoku
        playerTwoConstraint.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
    ...
    void showAddItemDialog(Context c)
    {
        ...
        AlertDialog dialog = new AlertDialog.Builder(c)
                ...
                .setPositiveButton(getResources().getString(R.string.set_timer_dialog), new DialogInterface.OnClickListener()
                {
                    @Override
